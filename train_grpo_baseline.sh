...
WAND_PROJECT='Search-R1-baseline1'

# Clean up any existing Ray instances to avoid actor registry conflicts
echo "Cleaning up existing Ray instances..."
/workspace/wshao/searchr1/bin/python -c "import ray; ray.shutdown()" 2>/dev/null || true
...
export EXPERIMENT_NAME=nq-search-r1-grpo-qwen2.5-3b-baseline1
